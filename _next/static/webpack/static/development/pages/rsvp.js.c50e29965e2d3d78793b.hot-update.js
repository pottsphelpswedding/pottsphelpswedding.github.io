...
/* harmony import */ var _rsvp_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./rsvp.css */ "./pages/rsvp.css");
/* harmony import */ var _rsvp_css__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_rsvp_css__WEBPACK_IMPORTED_MODULE_10__);
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(RSVP, [{
    ...
    value: function onSubmit(e) {
      e.preventDefault();
      var db = _lib_firebase__WEBPACK_IMPORTED_MODULE_11__["default"].firestore();
      db.collection("rsvps").add(this.state).then(function (docRef) {
        console.log("Document written with ID: ", docRef.id);
        next_router__WEBPACK_IMPORTED_MODULE_9___default.a.push({
          pathname: '/',
          query: {
            flashMessage: 'rsvpSuccess'
          }
        });
...
//# sourceMappingURL=rsvp.js.c50e29965e2d3d78793b.hot-update.js.map