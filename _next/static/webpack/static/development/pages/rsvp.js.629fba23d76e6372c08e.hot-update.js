...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(RSVP, [{
    ...
    value: function onSubmit(e) {
      e.preventDefault();
      var newPostKey = _lib_firebase__WEBPACK_IMPORTED_MODULE_10__["default"].firestore().ref().child('rsvps').push().key;
      _lib_firebase__WEBPACK_IMPORTED_MODULE_10__["default"].firestore().ref("rsvps/".concat(newPostKey)).set(this.state, function (err) {
        if (err) {
...
//# sourceMappingURL=rsvp.js.629fba23d76e6372c08e.hot-update.js.map