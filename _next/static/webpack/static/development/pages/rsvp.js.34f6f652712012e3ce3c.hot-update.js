  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(RSVP, [{
    ...
    value: function onSubmit(e) {
      ...
      var _this$state = this.state,
          ...
          message = Object(_babel_runtime_corejs2_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0__["default"])(_this$state, ["data"]);

      db.collection("rsvps").add(data).then(function (docRef) {
        console.log("Document written with ID: ", docRef.id);
        message = "We got your rsvp!";
...
//# sourceMappingURL=rsvp.js.34f6f652712012e3ce3c.hot-update.js.map