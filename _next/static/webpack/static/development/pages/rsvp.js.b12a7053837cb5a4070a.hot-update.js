...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(RSVP, [{
    ...
    value: function onSubmit(e) {
      ...
      _lib_firebase__WEBPACK_IMPORTED_MODULE_10__["default"].database().ref("rsvps/".concat(newPostKey)).set(this.state, function (err) {
        if (err) {
          console.log("Failed");
        }
      });
...
//# sourceMappingURL=rsvp.js.b12a7053837cb5a4070a.hot-update.js.map